...
public class diseaseMap extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double latitude = getIntent().getDoubleExtra("Latitude",69);
        double longitude=getIntent().getDoubleExtra("Longitude",69);
